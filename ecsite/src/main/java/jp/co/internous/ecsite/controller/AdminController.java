...
@Controller//このクラスをControllerとして認識
@RequestMapping("/ecsite/admin")//Controller処理対象となるURLを指定
public class AdminController {
	...
	@PostMapping("/welcome")//@RequestMappingのPOSTリクエスト用
